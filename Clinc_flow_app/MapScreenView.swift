...
////                navItemContent(systemName: "house", title: "Home", isSelected: false)
////            }
////            .buttonStyle(.plain)
////
////            Spacer()
////
////            NavigationLink(destination: MyVisitDashboardView()) {
////                navItemContent(systemName: "calendar", title: "Visit", isSelected: false)
////            }
////            .buttonStyle(.plain)
////
////            Spacer()
////
////            navItemContent(systemName: "map", title: "Map", isSelected: true)
////
////            Spacer()
////
////            NavigationLink(destination: ProfileView()) {
////                navItemContent(systemName: "person", title: "Profile", isSelected: false)
////            }
////            .buttonStyle(.plain)
////        }
...
//                Spacer()
//                
//                tabItem(icon: "map", title: "Map", isSelected: true) {
//                    //navigateToMapView = true
//                }
//                
//                Spacer()
//                
//                tabItem(icon: "person.fill", title: "Profile", isSelected: false) {
...
//    
//
//    private func navItemContent(systemName: String, title: String, isSelected: Bool) -> some View {
//        VStack(spacing: 6) {
...
//                    .foregroundColor(
//                        isSelected
//                        ? Color(red: 0.10, green: 0.73, blue: 0.70)
//                        : Color(.systemGray2)
//                    )
//            }
//
...
extension MapScreenView {
    ...
    private func levelButton(_ title: String, selected: Bool) -> some View {
        Button {
            ...
            Text(title)
                .font(.system(size: 17, weight: .bold))
                .foregroundColor(selected ? .black : Color(.systemGray))
                .frame(width: 48, height: 48)
                .background(selected ? Color(red: 0.16, green: 0.87, blue: 0.83) : Color.clear)
        }
        .buttonStyle(.plain)
    ...
    private var bottomTabBar: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                NavigationLink(destination: MyVisitDashboardView()) {
                    navItemContent(systemName: "calendar", title: "Visits", isSelected: false)
                }
                .buttonStyle(.plain)
                ...
                NavigationLink(destination: ProfileView()) {
                    navItemContent(systemName: "person.fill", title: "Profile", isSelected: false)
                }
                .buttonStyle(.plain)
            }
            .padding(.horizontal, 30)
