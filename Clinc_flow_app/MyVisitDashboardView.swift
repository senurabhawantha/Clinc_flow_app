                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 20) {
                            ...
                            TimelineItem(
                                time: "09:00 AM",
                                text: "Checked in at Main Lobby kiosk.",
                                isCurrent: false,
                                isLast: true
                            )
                        }
                        ...
                        // Navigation Links
                        NavigationLink(
                            destination: QueueStatusView(),
                            isActive: $navigateToQueueStatus
                        ) {
                            EmptyView()
                        }
                        
                        NavigationLink(
                            destination: MapScreenView(),
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 16) {
            ...
            VStack(spacing: 0) {
                Circle()
                    .strokeBorder(
                        isCurrent ? Color.cyan : Color.gray.opacity(0.3),
                        lineWidth: 2
                    )
